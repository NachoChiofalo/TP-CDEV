...
// ========================
// DATOS DE OBRAS DE ARTE - OPTIMIZADO Y BALANCEADO
// ========================

const obrasDeArte = [
    // ========== SALA 1 - Pared frontal ==========
    {
        titulo: "La Mona Lisa",
        artista: "Leonardo da Vinci",
        año: "1503-1519",
        textura: "assets/texturas/mona_lisa.webp",
        tamaño: { ancho: 2.2, alto: 1.6 },
        posicion: new THREE.Vector3(-4, 2, -5.9),
    ...
    },
    {
        ...
        tamaño: { ancho: 2.4, alto: 1.8 },
        posicion: new THREE.Vector3(0, 2, -5.9),
    ...
    },
    {
        ...
        tamaño: { ancho: 2.2, alto: 2.0 },
        posicion: new THREE.Vector3(4, 2, -5.9),
        descripcion: "Serie icónica de naturalezas muertas",
        esGanador: true
    },
    
    // ========== SALA 1 - Paredes laterales ==========
    {
        titulo: "Las Meninas",
        artista: "Diego Velázquez",
        año: "1656",
        textura: "assets/texturas/las_meninas.webp",
        tamaño: { ancho: 2.2, alto: 2.4 },
        posicion: new THREE.Vector3(-8.9, 2, -1),
    ...
    // ========== SALA 2 - Pared frontal ==========
    {
        titulo: "Guernica",
        artista: "Pablo Picasso",
        año: "1937",
        textura: "assets/texturas/guernica.webp",
        tamaño: { ancho: 3.2, alto: 1.6 },
        posicion: new THREE.Vector3(-2, 2, 17.9),
    ...
    },
    {
        ...
        tamaño: { ancho: 2.0, alto: 2.2 },
        posicion: new THREE.Vector3(2, 2, 17.9),
        descripcion: "Obra maestra del Renacimiento"
    },
    
    // ========== SALA 2 - Paredes laterales ==========
    {
        ...
        posicion: new THREE.Vector3(-8.9, 2, 15),
    ...
    },
    {
        ...
        tamaño: { ancho: 1.8, alto: 2.0 },
        posicion: new THREE.Vector3(8.9, 2, 15),
        descripcion: "La Mona Lisa del Norte"
    },
    
    // ========== PASILLO - Paredes laterales ==========
    {
        titulo: "Van Gogh Autorretrato",
        artista: "Vincent van Gogh",
        año: "1889",
    ...
    {
        titulo: "Obra Maestra Clásica",
        artista: "Maestro Clásico",
        año: "1800",
...
function inicializar() {
    console.log('Iniciando museo optimizado...');
    try {
        crearEscena();
        crearCamara();
        crearRenderizador();
        ...
        console.log('Museo optimizado inicializado');
        animar();
    } catch (error) {
...
function inicializarAudio() {
    ...
    // Crear audio
    audioMusica = new THREE.Audio(listener);
    
    // Cargar sonido de ambiente (usando un archivo de placeholder)
    const audioLoader = new THREE.AudioLoader();
    
    // Por ahora crear un sonido sintetizado simple
    ...
    console.log('Audio de ambiente configurado');
}

function reproducirMusica() {
    if (!audioMusica && typeof THREE.Audio !== 'undefined') {
        try {
            inicializarAudio();
        } catch (error) {
...
function crearObrasConTexturas() {
    console.log('Cargando obras de arte optimizadas...');
...
function verificarVictoria() {
    if (juegoTerminado || !cuadroGanador) return;
    
    const posicionJugador = camara.position;
    const posicionCuadro = cuadroGanador.position;
    
    const distancia = posicionJugador.distanceTo(posicionCuadro);
    
    if (distancia < 2.0) { // Distancia de activación
        mostrarVictoria();
    }
}
...
function mostrarVictoria() {
    ...
    overlayVictoria.innerHTML = `
        <div id="menuVictoria">
            ...
            <p>Encontraste la obra maestra: "Los Girasoles" de Vincent van Gogh</p>
    ...
    // Estilos de botones
    const botones = overlayVictoria.querySelectorAll('button');
    ...
    document.getElementById('botonSalir').addEventListener('click', () => {
        document.getElementById('overlayVictoria').remove();
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('Inicializando museo optimizado...');
